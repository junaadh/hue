...
impl PlaybackSnapshot {
    fn from_raw(raw: &sys::HuePlaybackInfoRaw) -> Self {
        Self {
            song: SongSnapshot {
                title: cstr(raw.song_info.title).to_owned(),
                artist: cstr(raw.song_info.artist).to_owned(),
                album: cstr(raw.song_info.album).to_owned(),
                app_name: cstr(raw.song_info.app_name).to_owned(),
            },
